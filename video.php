...
<body class="font-sans">
 ...
 <div class="relative group rounded-3xl overflow-hidden shadow-2xl border border-blue-600/30 backdrop-blur-md">
  <div class="relative w-full" style="padding-top: 56.25%;"> <!-- 16:9 ratio -->
    <iframe 
      class="absolute top-0 left-0 w-full h-full rounded-3xl"
      src="https://www.youtube.com/embed/3v4OMH9c2dQ?autoplay=0&rel=0&modestbranding=1"
      title="Bali Diving Adventures"
      frameborder="0"
