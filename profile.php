...
<head>
    ...
    <meta name="description" content="Dive Bali with Bali Diving—PADI 5-Star guides, small groups, hotel pickup. See manta rays, the Liberty wreck, and vibrant reefs. Book your adventure today." />
...
<body class="font-sans">
    <?php include('template/nav.php')?>
        <?php include('template/member-profile.php')?>
