...
<title>Nusa Penida | Bali Diving</title>
<?php echo generate_seo_tags($page); ?>
<link rel="icon" href="bali-diving-logo.svg" type="image/svg+xml">
<meta name="description" content="Discover world-class scuba diving at Nusa Penida in Bali. Explore vibrant reefs, meet marine life, and experience unforgettable underwater adventures with Bali Diving.">
<meta name="keywords" content="Nusa Penida, Bali diving, scuba diving Bali, dive sites Bali, underwater adventure, coral reefs, manta rays, diving tours">
...
<section class="relative py-20 px-6 bg-white overflow-hidden fade-in">
  <div class="max-w-6xl mx-auto text-center">
    <h1 class="text-5xl md:text-6xl font-extrabold text-navy mb-6 tracking-tight">Nusa Penida</h1>
    <p class="text-lg text-gray-700 mb-10 leading-relaxed">
      Dive into the beauty of Nusa Penida — one of Bali’s most stunning underwater destinations. 
