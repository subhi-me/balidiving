...
<section class="relative py-20 px-6 bg-white overflow-hidden fade-in">
  <div class="max-w-6xl mx-auto text-center">
    <h1 class="text-5xl md:text-6xl font-extrabold text-navy mb-6 tracking-tight">Courses Freediving</h1>
    <p class="text-lg text-gray-700 mb-10 leading-relaxed">
      Dive into the beauty of Courses Freediving — one of Bali’s most stunning underwater destinations. 
