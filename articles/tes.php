  ...
  <div class="max-w-3xl mx-auto px-4 md:px-6 text-slate-900">
    ...
    <header class="mb-10 text-center">
      ...
      <h2 class="text-lg md:text-xl text-slate-700 max-w-2xl mx-auto">
        Copy this prompt and paste it into your AI writer. The AI should return a ready-to-use Tailwind article section about "tes" for Bali Diving.
      </h2>
    </header>

    <figure class="mb-10 overflow-hidden rounded-2xl border border-slate-200 shadow-xl bg-white">
      <img 
        src="https://balidiving.com/images/thumbnails/13-bali-diving-underwater.jpg"
        alt="tes"
...
Requirements:
- Main article title (topic): "Tes"
- Main SEO keyword (use naturally, not spam): "tes"
...
Content guidelines:
- Explain why "tes" is important for divers in Bali.
