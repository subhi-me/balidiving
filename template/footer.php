    ...
    <div class="grid grid-cols-2 md:grid-cols-5 gap-8">
      ...
      <div class="col-span-2 md:col-span-1">
        <div class="flex items-center space-x-2 mb-4">
          <div class="w-10 h-10 flex-shrink-0 flex items-center justify-center"><a href="https://balidiving.com/explore/">
            <img src="../images/bali-diving-logo.svg" alt="Bali Diving Logo" class="w-full h-auto filter">
          </div>
          <span class="text-2xl font-bold">Bali Diving</span></a>
        </div>
...
items
      ...
      <div>
        ...
        <ul class="space-y-2 text-lightblue text-sm">
          ...
          <li><a href="https://balidiving.com/scuba-diving-certification" class="hover:text-white transition-colors">Open Water Diver</a></li>
          <li><a href="https://balidiving.com/scuba-diving-certification" class="hover:text-white transition-colors">Advanced Open Water</a></li>
          <li><a href="https://balidiving.com/scuba-diving-certification" class="hover:text-white transition-colors">Rescue Diver</a></li>
          <li><a href="https://balidiving.com/scuba-diving-certification" class="hover:text-white transition-colors">Divemaster</a></li>
          ...
          <li><a href="/sites/tulamben-usat-liberty" class="hover:text-white transition-colors">Tulamben (USAT Liberty)</a></li>
          <li><a href="/sites/amed-jemeluk-bay" class="hover:text-white transition-colors">Amed & Jemeluk Bay</a></li>
      ...
      <div>
        ...
        <ul class="space-y-2 text-lightblue text-sm">
          ...
          <li><a href="/shop/equipment.php" class="hover:text-white transition-colors">Equipment</a></li>
          <li><a href="/shop/equipment" class="hover:text-white transition-colors">Apparel & Merch</a></li>
          <li><a href="/shop/equipment" class="hover:text-white transition-colors">Accessories</a></li>
          <li><a href="/shop/equipment" class="hover:text-white transition-colors">Equipment Rentals</a></li>
          <li><h5 class="font-semibold text-white mb-1 mt-3">Membership</h5></li>
          <li><a href="https://balidiving.com/register" class="hover:text-white transition-colors">Join Our Dive Club</a></li>
          <li><a href="https://balidiving.com/login" class="hover:text-white transition-colors">Member Benefits</a></li>
          <li><a href="/events" class="hover:text-white transition-colors">Exclusive Events</a></li>
        </ul>
      </div>
      ...
      <div>
        ...
        <ul class="space-y-2 text-lightblue text-sm">
          ...
          <li><a href="https://balidiving.com/articles" class="hover:text-white transition-colors">Dive Blog</a></li>
           <li><a href="https://balidiving.com/weather" class="hover:text-white transition-colors"> Weather</a></li>
          ...
          <li><a href="/terms-of-service" class="hover:text-white transition-colors">Terms of Service</a></li>
                    <li><a href="/return-policy" class="hover:text-white transition-colors">Return Policy</a></li>
