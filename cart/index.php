...
<link rel="icon" href="https://balidiving.com/bali-diving-favicon.png" type="image/png" sizes="144x144">
  <style>
    * { box-sizing: border-box; }
    ...
    .products-section { flex: 1 1 320px; }
    ...
    .product-name { font-size: 1rem; font-weight: 600; color: #111827; }
    .product-price { font-size: 1.1rem; font-weight: 700; color: #0070d3; }
    ...
    .read-article-link:hover { text-decoration: underline; }
    ...
    .add-to-cart-btn { background: #0070d3; color: #ffffff; }
    .add-to-cart-btn:hover { background: #0654a5; }
    ...
    .enquire-btn:hover { background: #1b7f8e; }
    ...
    .cart-booking-label { font-size: 0.7rem; opacity: 0.9; }
    .cart-booking-id { font-size: 0.8rem; font-weight: 600; }
    ...
    .cart-name { font-size: 0.85rem; font-weight: 600; color: #111827; }
    .cart-price { font-size: 0.8rem; color: #0070d3; font-weight: 600; }
    ...
    .summary-label { font-size: 0.9rem; font-weight: 600; color: #111827; }
    .summary-amounts {
      text-align: right;
      font-size: 0.9rem;
      font-weight: 700;
  ...
  <script>
    // tombol Checkout: langsung ke halaman cart
    function checkout() {
      window.location.href = "https://balidiving.com/cart/cart";
    }
  </script>
</head>
<body>
  ...
  <div class="demo-container">
    ...
    <div class="products-section">
      <div class="products-grid">
        <section id="snorkeling">
          <?php include __DIR__ . '/snorkeling.php'; ?>
        </section>

        <section id="try-diving">
          <?php include __DIR__ . '/trydiving.php'; ?>
        </section>

        <section id="fun-diving">
          <?php include __DIR__ . '/fundiving.php'; ?>
        </section>

        <?php include __DIR__ . '/safari.php'; ?>

        <section id="learn-diving">
          <?php include __DIR__ . '/learndiving.php'; ?>
        </section>
      </div>
    </div>
    ...
    <aside class="floating-cart">
      ...
      <footer class="cart-footer">
        ...
        <!-- Full Name & Email Address disembunyikan (tetap aman walau cart.js mencari element ini) -->
...
<a href="/cart/my-booking.php"
   class="pay-btn text-center no-underline"
